...
export async function createTestEnvironmentAngularWithO3rCore(inputOptions: Partial<CreateTestEnvironmentAngularWithO3rCoreOptions>) {
  ...
  await createWithLock(async () => {
    ...
    if (options.generateMonorepo) {
      packageManagerExec(`ng add @o3r/core@${o3rVersion} --skip-git --skip-confirmation`, execAppOptions);
      ...
      packageManagerExec(`ng add @o3r/core@${o3rVersion} --project-name=test-app --skip-git --skip-confirmation`, execAppOptions);
    } else {
      packageManagerExec(`ng add @o3r/core@${o3rVersion} --skip-git --skip-confirmation`, execAppOptions);
    }
